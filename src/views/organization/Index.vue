...
<script>
import {getOrganizationByYearAndName, getUserListByOrganizationId} from '@/network/api/organization';
...
export default {
    ...
    methods: {
        ...
        getOrganizationUserList() {
            ...
            getUserListByOrganizationId(OrganizationUserQueryParam).then(res => {
                if (res.code !== 200) {
                    return this.$message.error(res.message);
                }
