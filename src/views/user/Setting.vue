                        ...
                        <el-row :gutter="10">
                            <el-col :span="24">
                                <el-form-item label="头像：" prop="logo">
                                    <single-upload :value="user.icon" @iconUrl="iconUrl"></single-upload>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="10">
                            <el-col :span="12">
                                ...
                                <el-form-item label="性别">
                                    <template>
                                        <el-radio v-model="user.gender" label="1"><i class="el-icon-female"></i>男
                                        </el-radio>
                                        <el-radio v-model="user.gender" label="0"><i class="el-icon-male"></i>女
                                        </el-radio>
                                    </template>
                                </el-form-item>
                                <el-form-item>
